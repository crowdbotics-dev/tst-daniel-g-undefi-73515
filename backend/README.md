...
## Project Structure
    ...
    ├── tst_daniel_g_undefi_73515  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_g_undefi_73515`
...
2. Clone this repo and `cd tst_daniel_g_undefi_73515`
